...
const GifAppDump: React.FunctionComponent<Props & ReduxStateProps & DispatchProps> = (props) => {
    ...
    return <div style={constantStyles.container}>
        ...
        {trendingGifs &&
            <div data-testid={'gifList'} style={constantStyles.gifListContainer}>
                {
                    trendingGifs?.map(tg =>
                        <div style={dynamicStyles.cardContainer} key={tg.id}>
        ...
        {prevUrl !== '' && <div data-testid={'previewComponent'} style={{ position: 'absolute', height: '100%', width: '100%', padding: '200px 0px', textAlign: 'center' }} onClick={() => setPrevUrl('')}>
